...
function App() {
  ...
  const postMatchResult: Post | undefined | null =
    postMatch === null
      ? null
      : posts.find((p: Post) => p.id === Number(postMatch.params.id));
    ...
    <div className="App">
      ...
      <main className="main">
        <Routes>
          <Route
            path="/"
            element={<View posts={posts} addToList={addToList} />}
          />
          ...
          <Route
            path="post/:id"
            element={
              <PostPage post={postMatchResult ? postMatchResult : null} />
            }
          />
          <Route
            path="/myprofile"
